...
const AddDoctor = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const datas={name:name,department:department,speciality:speciality,hospital:hospital,language:language,image:image}
    ...
    try{
        const response = await axios.post('/api/admin/addDoctor',formData ,{
            headers: {
