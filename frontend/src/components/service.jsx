...
const service = () => {
  return (
    <>
      <h1 className='flex justify-center font-semibold text-3xl mt-8'>How Our Health System Works?</h1>

      <div className='w-full py-[4rem] px-4 bg-white '>
        <div className='flex w-full mx-auto gap-8 md:flex-row flex-col justify-around '>
          <div className='  flex flex-col p-4 my-4 rounded-lg  items-center justify-center border-black border'>
          ...
          <div className='  flex flex-col p-4 my-4 rounded-lg justify-center items-center  border-black border'>
